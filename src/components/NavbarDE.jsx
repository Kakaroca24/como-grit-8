...
export default function NavbarDE() {
  ...
  const navLinks = [
    ...
    { path: "/de/about", label: "Über uns" },
    { path: "/de/services", label: "Dienstleistungen" },
    { path: "/de/gallery", label: "Galerie" },
    { path: "/de/contact", label: "Kontakt" },
    { path: "/de/construction", label: "Hochbau" }
  ]
      ...
      <nav className="max-w-7xl mx-auto px-6 py-2">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            {navLinks.map((link) => {
              const isConstruction = link.path === "/de/construction"
