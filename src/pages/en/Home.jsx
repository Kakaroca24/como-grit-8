        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="max-w-3xl">
            <h1 className="text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Precision Metal Fabrication, Construction & Industrial Solutions
            </h1>
            <p className="text-xl text-slate-300 mb-8 leading-relaxed">
              Advanced metal processing, construction expertise, and cutting-edge technologies delivering exceptional quality, durability, and precision for your industrial and building projects.
            </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-20 items-center">
          <div>
            ...
            <div className="text-base text-slate-600 leading-7 space-y-4 mb-10">
              ...
              <p>Today, COMO GRIT d.o.o stands as a trusted name in the industry, known for our expertise in metal processing and fabrication, as well as our work in construction projects for both residential and non-residential buildings. We are committed to delivering outstanding results on every project.</p>
            </div>
...
function Services() {
  const services = [
    ...
    {
      id: "07.",
      title: "Machining Tools Fabrication",
      image: image1,
      className: "md:col-span-8 h-[450px]"
    },
    {
    ...
    {
      id: "09.",
      title: "Industrial Aluminum Processing Services",
      image: image11,
      className: "md:col-span-8 h-[450px]"
    },
    {
      id: "11.",
      title: "Metal Concentrates",
      image: image12,
      className: "md:col-span-4 h-[450px]"
    },
    {
      id: "12.",
      title: "CNC Manufacturing for Precision Auto Parts",
      image: image17,
      className: "md:col-span-6 h-[550px]"
    },
  ];
